...
def test_denominator_boundary_contract_for_k3():
    ...
    assert consistent(256, 256, 3) is True
    assert consistent(255, 256, 3) is True
    assert consistent(259, 256, 3) is True
    assert consistent(254, 256, 3) is False
    assert consistent(260, 256, 3) is False
