...
def _worker(layer):
    return {
        ...
        "phase": "shrunk",
        "logical_pages": 12,
        "scheduler_real_pages": 6,
        "physical_page_cap": 6,
        "resident_history_pages": 4,
        "active_real_pages": 2,
        "hole_pages": 6,
        "hole_unique_ids": 1,
        "null_block_id": 0,
        "historical_selected": 10,
        "historical_resident_kept": 4,
        "historical_selected_dropped": 6,
        "cpu_published": True,
        "cpu_restored_after_shrink": True,
        "cpu_restore_exact": True,
        "d2h_bytes": 4 * 32768,
        "d2h_jobs": 2,
        "h2d_bytes": 4 * 32768,
        "h2d_jobs": 2,
        "staging_pages": 2,
        "staging_bytes": 2 * 32768,
    }
...
def test_q2c_runtime_summary_go():
    ...
    sched = [{
        ...
        "logical_row_pages": 12,
        "real_pages_before": 12,
        "real_pages_after": 6,
        "freed_pages": 6,
        "physical_page_cap": 6,
        "resident_history_pages": 4,
...
def test_q2c_runtime_summary_rejects_no_scheduler_shrink():
    mod = _load()
    response = {"target_codes_in_order": True, "finish_reason": "stop"}
    out = mod.summarize(response, [], [_worker("a"), _worker("b")], _plan())
